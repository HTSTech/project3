  ...
  export default function HomeCopy() {
    ...
    async function getData() {
      ...
      axios.get("https://nqhkpgaezalnpxtizxzv.supabase.co/storage/v1/object/public/projects/fa46efe7-236a-403c-b329-0fd14699786f/project3/HomeCopy/index.html").then(res=>{
        console.log("res=> ",res);
        document.getElementById("HomeCopyID").innerHTML = res.data;
        
        //* css
        axios.get("https://nqhkpgaezalnpxtizxzv.supabase.co/storage/v1/object/public/projects/fa46efe7-236a-403c-b329-0fd14699786f/project3/HomeCopy/style.css").then(CssRes=>{
          ...
          axios.get("https://nqhkpgaezalnpxtizxzv.supabase.co/storage/v1/object/public/projects/fa46efe7-236a-403c-b329-0fd14699786f/project3/HomeCopy/script.js").then(JsRes=>{
